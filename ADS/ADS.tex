...
\chapter{Algorithms}
\section*{Preamble}
In this section I will make use of various logical symbols, figure \ref{fig:logicalSymbols} indicates their meanings
\begin{figure}[H]
...
\begin{nproblem}[The Comparison Sorting Problem]
    ...
    \mypar \textbf{Input:} A sequence $(a_1, \dots, a_n)$ of values of a type which can be compared with a total order relation $<$
