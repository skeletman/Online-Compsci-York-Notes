...
\end{defi}
\subsection{Example Computational Problems}
...
\begin{impl}[Array-Based Circular Queue]
    ...
    \begin{figure}[H]
        ...
        \begin{tikzpicture}[stack/.style={rectangle split, rectangle split parts=#1,draw, anchor=center}]
            ...
            \node[right = 1.2cm of A] (B) {$Q.enqueue$ x};
            ...
            \node[right = 1.2cm of B] (C) {$Q.dequeue$};
    ...
    \begin{figure}[H]
        ...
        \begin{tikzpicture}[stack/.style={rectangle split, rectangle split parts=#1,draw, anchor=center}]
            ...
            \node[right = .8cm of A] (B) {\small $Q.enqueue$ g};
            \node[below = 0.2cm of B] (QBText) {$Q$};
            \node[stack=7, below = 0cm of QBText] (QB) {
                \nodepart{one}g
                \nodepart{two}f
            ...
            \node[right = .3cm of B] (C) {\small $Q.enqueue$ h};
            \node[below = 0.2cm of C] (QCText) {$Q$};
            \node[stack=7, below = 0cm of QCText] (QC) {
                \nodepart{one}g
                \nodepart{two}f
            ...
            \node[right = .3cm of C] (D) {\small$Q.dequeue$};
            \node[below = 0.2cm of D] (QDText) {$Q$};
            ...
            \node[right = .5cm of D] (E) {\small$Q.dequeue$};
            \node[below = 0.2cm of E] (QEText) {$Q$};
...
\begin{nproblem}[The Sorting Problem]
